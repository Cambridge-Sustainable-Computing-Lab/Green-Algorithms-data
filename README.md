...
You are free to use, share, and adapt the data under the terms of the ODbL. See [LICENSE](v3.1/carbon-intensity/electricitymap/LICENSE) for full license text.
...
You are free to use, share, and adapt the data under the terms of the CC BY-NC-SA 4.0. See [TDP LICENSE](v3.1/chips/wikichips/LICENSE) for full license text.
